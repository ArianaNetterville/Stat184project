...
A. QMD line numbers where at least 3 data sources are imported: 58, 59, 74-79

## Data Wrangling / Cleaning / etc.

**DO AT LEAST FOUR OF THE FOLLOWING:**

A. QMD line number(s) for general data wrangling: 144-148, 157-161, 194-196, 215-217

B. QMD line number(s) for a join operation: 193

C. QMD line number(s) for `pivot_wider` or `pivot_longer` operation (or equivalent):

D. QMD line number(s) for use of regular expressions: 96, 106, 118

E. QMD line number(s) for use of reduction and/or transformation functions: 175-179, 184-188
...
A. QMD line number(s) for **all data visualizations**: 132-133, 204-205, 225-226
...
A. Include QMD line numbers for **all tables**: 144-148, 158,161
