...
A. QMD line numbers where at least 3 data sources are imported: 59, 60, 75-80

## Data Wrangling / Cleaning / etc.

**DO AT LEAST FOUR OF THE FOLLOWING:**

A. QMD line number(s) for general data wrangling: 145-149, 158-162, 195-197, 216-218

B. QMD line number(s) for a join operation: 194

C. QMD line number(s) for `pivot_wider` or `pivot_longer` operation (or equivalent):

D. QMD line number(s) for use of regular expressions: 97, 107, 119

E. QMD line number(s) for use of reduction and/or transformation functions: 176-180, 185-189
...
A. QMD line number(s) for **all data visualizations**: 133-134, 205-206, 226-227
...
A. Include QMD line numbers for **all tables**: 145-149, 159,162
